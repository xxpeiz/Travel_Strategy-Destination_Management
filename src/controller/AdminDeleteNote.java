...
@WebServlet(name = "AdminDeleteNote", urlPatterns = "/AdminDeleteNote")
public class AdminDeleteNote extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (noteIdStr == null || noteIdStr.isEmpty()) {
            ...
            if (success) {
                session.setAttribute("success", "游记删除成功");
            } else {
                session.setAttribute("error", "游记删除失败");
            }
