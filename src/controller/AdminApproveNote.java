...
@WebServlet(name = "AdminApproveNote", urlPatterns = "/AdminApproveNote")
public class AdminApproveNote extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (noteIdStr == null || noteIdStr.isEmpty()) {
            ...
            boolean success = noteService.approveNote(noteId);

            if (success) {
                session.setAttribute("success", "游记审核通过成功");
            } else {
                session.setAttribute("error", "游记审核通过失败");
            }
