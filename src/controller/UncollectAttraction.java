...
@WebServlet(name = "UncollectAttraction", urlPatterns = "/UncollectAttraction")
public class UncollectAttraction extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            boolean success = collectionService.removeCollection(userId, attractionId);
